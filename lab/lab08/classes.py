...
class ProfessorCard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        for player_deck_card in player.deck.cards:
            player_deck_card.attack+=atta
            player_deck_card.defense+=defe
        opponent.deck.cards=[card for card in opponent.deck.cards if (card.attack!=atta and card.defense!=defe)]
