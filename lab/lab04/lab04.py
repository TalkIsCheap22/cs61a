...
def reverse_recursive(lst):
    ...
    if size==0:
        ...
        return [lst[size-1]]+reverse_recursive(lst[1:size-1])+[lst[0]]
...
def distance(city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    square=(get_lon(city_a)-get_lon(city_b))**2+(get_lat(city_a)-get_lat(city_b))**2
    return square**0.5
...
def closer_city(lat, lon, city_a, city_b):
    ...
    if distance(city_temp,city_a)>distance(city_temp,city_b):
